...
\setlist{parsep=0.7em}
% VERTICAL FOOTNOTE SEPARATION
...
% VSPACE BEFORE LAST UPDATE---ADJUST THIS TO GET BETTER PAGE BREAKS
% also possible to adjust the skip option to parskip package
% also possible to adjust the vertical enumeration spacing
\vspace{1em}
% LAST UPDATE
Last update:\@ \today{}%
% VSPACE AFTER LAST UPDATE---ADJUST THIS TO GET BETTER PAGE BREAKS
% also possible to adjust the skip option to parskip package
% also possible to adjust the vertical enumeration spacing
\vspace{1em}
% SUBSEC: BASIC INFO
